...
public class Heapsort {
	...
	public void heapsort(int[] v) {
		...
		for (int i = v.length - 1, n = v.length; i > 0; i--) {
			...
			/*
			 * Percorre a árvore de cima para baixo. Ao final do 1a iteração o maior valor
			 * estará na última posição, ao final da 2a iteração o 2o maior valor estará na
			 * penúltima posição e assim sucessivamente
			 */
